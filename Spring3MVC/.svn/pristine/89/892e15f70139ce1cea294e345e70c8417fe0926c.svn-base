...
public interface DAOSportTrainer {

	public void addSportTrainer(SportTrainer sportTrainer,Long idUser);
	
	public boolean deleteSportTrainer(Long userId);
	
	public SportTrainer getSportTrainer(Long userId);
	
	public void modifySportTrainer(SportTrainer sportTrainer);
