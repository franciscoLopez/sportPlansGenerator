...
public class User extends BaseEntity implements Serializable, UserDetails {
	...
	public static final String A_USERNAME = USERNAME2;
	...
	private static final String C_USERNAME = USERNAME2;
	...
	@JoinTable(name = "group_members", joinColumns = @JoinColumn(name = USERNAME2, table = "users", referencedColumnName = USERNAME2), inverseJoinColumns = @JoinColumn(name = "group_id"))
