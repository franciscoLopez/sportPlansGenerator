...
/*codigo para el filtro en la tabla de monitores*/
  	$(function() { 
 		var theTable = $('#sportTrainersTable')
 		$("#filterMonitores").keyup(function() {
...
<section class="panelIzq">
	...
	<div id="infoSportCentre">
		<c:if test="${!empty sportCentreName}">
			<h2>
...
<section class="panelDer">
	<div id="variableMonitores">
		...
		<div class="redondeado shadow fondoForm padding2">
			<div><form id="filter-formMonitores"><label for="filterMonitores">Filtrar</label><input name="filter" id="filterMonitores" value="" maxlength="20" size="20" type="text"></form></div>
			<table class="monitoresTable">
				<tbody>
					<tr>
	...
	<div id="variableConfiguracion">
		...
		<div class="redondeado shadow fondoForm padding2">
			<div>
				<input id="perfilSportCentre" type="button"
