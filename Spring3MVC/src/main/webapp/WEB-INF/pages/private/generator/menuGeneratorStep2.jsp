...
$(document).ready(function() {
	...
	$("input:checkbox").live('click',function(){
		...
		if(checked < min_checked){
	        ...
	        alert("Mínimo " + min_checked + " tipo de equipamiento");
		}
	});
});
...
<section id="fSportPlansGenerator">
	<form:form id="formSportPlansGenerator" commandName="dtoSportPlan" class="redondeado shadow fondoForm padding2">
		...
		<div id="durationDivStep1">
			<p>DURACIÓN: <span id="contenidoLevel">${dtoSportPlan.periods} periodos de ${dtoSportPlan.weeks} semanas <br>( ${dtoSportPlan.sessionsPerWeek} dias a la semana - ${dtoSportPlan.sessionsPerWeek * dtoSportPlan.periods * dtoSportPlan.weeks } días en total )</span></p>
		</div>
